...
public class Pix extends JPanel{
	...
	public Pix(JPanel panelPrincipal, CardLayout cards) {
		...
		copiar.addActionListener(e -> {
		    String codigoPix = "00020126380014BR.GOV.BCB.PIX0114..."; // código real do Pix
		    Toolkit.getDefaultToolkit().getSystemClipboard()
		           .setContents(new StringSelection(codigoPix), null);

		    JOptionPane.showMessageDialog(this, "Código PIX copiado para a área de transferência!");

		    // Opcional: marcar como pago
