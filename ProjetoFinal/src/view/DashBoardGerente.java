...
public class DashBoardGerente extends JPanel {
    ...
    public DashBoardGerente(Funcionario usuario, JPanel panelPrincipal, CardLayout card) {
        this.usuarioAtual = usuario;
        this.funcionarioCtrl = new FuncionarioController();

        // ✅ Define o layout principal como BorderLayout (necessário para o CardLayout funcionar corretamente)
    ...
    private void inicializarLayout() {
        ...
        // ✅ Adiciona corretamente os painéis ao BorderLayout
    ...
    private JPanel criarPainelResumo() {
        ...
        painel.add(criarCard("Total Funcionários", new Color(76, 175, 80),
                String.valueOf(funcionarioCtrl.ListarFuncionarios().size())));
