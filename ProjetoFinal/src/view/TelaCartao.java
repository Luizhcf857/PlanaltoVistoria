...
public class TelaCartao extends JPanel {
		...
		public TelaCartao(JPanel principal, CardLayout card) {
			...
			continuar.addActionListener(e -> {
			    ...
			    PagamentoDAO.atualizarStatusPagamento(pagamento); // método no DAO

			    JOptionPane.showMessageDialog(this, "Pagamento realizado com sucesso!");
			    card.show(principal, "Vazio"); // volta para painel inicial
			});
