...
public class DashboardVistoriador extends JPanel {
    ...
    private JPanel criarMenuLateral() {
        ...
        JButton btnNovoAgendamento = criarBotaoMenu("Novo Agendamento");
        JButton btnNovoCliente = criarBotaoMenu("Novo Cliente");
        JButton btnNovoVeiculo = criarBotaoMenu("Novo Veículo");
        ...
        btnNovoAgendamento.addActionListener(e -> abrirFormularioAgendamento());
        btnNovoCliente.addActionListener(e -> abrirFormularioCliente());
        btnNovoVeiculo.addActionListener(e -> abrirFormularioVeiculo());
        btnVoltar.addActionListener(e -> cardPrincipal.show(painelPrincipal, "TelaLogin"));
        ...
        menu.add(btnRelat);
        menu.add(Box.createVerticalStrut(15));
        menu.add(btnNovoAgendamento);
        menu.add(Box.createVerticalStrut(15));
        menu.add(btnNovoCliente);
        menu.add(Box.createVerticalStrut(15));
        menu.add(btnNovoVeiculo);
