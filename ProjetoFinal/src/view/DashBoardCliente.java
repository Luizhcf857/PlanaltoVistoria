...
public class DashBoardCliente extends JPanel {
    ...
    class ButtonEditor extends DefaultCellEditor {
        ...
        public ButtonEditor(JCheckBox checkBox, JPanel painelPrincipal, CardLayout cardPrincipal,
            ...
            // Só dispara o editor, não executa o pagamento ainda
        ...
        public Object getCellEditorValue() {
            if (isPushed) {
                ...
                Object objVistoria = tableAgendamentos.getValueAt(row, 5); // coluna do id da vistoria
                int idVistoria = (objVistoria != null) ? (Integer) objVistoria : 0;

                // Pega o pagamento existente ou cria novo
                PagamentoController pagamento = null;
                if (idVistoria != 0) {
                ...
                // Verifica se já existe a tela de pagamento
